...
__all__ = ['download_enwik8_data', 'get_enwik8_dataloader', 'get_twin_sequence_dataloaders', 'get_lshlm_model',
           'get_synthetic_learner', 'get_lm_learner', 'init_wandb', 'run_exp']
...
#          verbose:Param(help="Print script logs", type=bool_arg, default=False)
    ...
    if task == 'synt':
        ...
        print('Getting dataloaders ...')
        dls = get_enwik8_dataloader(data_path=data_path, bs=bs, sl=max_seq_len, verbose=True)
        print('done')
